...
const QString QmitkSlicesInterpolator::TR_REINIT_INTERPOLATION = QGroupBox::tr("Reinit Interpolation");
    ...
    m_3DInterpolationEnabled(false)
{
  ...
  m_BtnReinit3DInterpolation = new QPushButton(TR_REINIT_INTERPOLATION, m_GroupBoxEnableExclusiveInterpolationMode);
